...
{
    public static IdentityBuilder AddBlazorServerIdentity<TUser, TRole>(this IServiceCollection services, Action<IdentityOptions> setupAction)
        where TUser : class
        where TRole : class
    {
        ...
        .AddCookie("BlazorServerCookieAuthentication", o =>
        {
